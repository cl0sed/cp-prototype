...
* [2025-04-18 13:26:00] - **Refine Proxy Strategy Rationale:**
  ...
  * **Refined Approach:** Modify Nginx `location /auth/` to *only* handle OPTIONS requests, preserving the critical SuperTokens CORS preflight logic. Remove the `proxy_pass` for non-OPTIONS requests within this block.
